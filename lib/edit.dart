...
class _EditState extends State<Edit> {
  ...
  Future _getData() async {
    try {
      final response = await http.get(Uri.parse(
          ...
          "http://192.168.1.14/sourcebackendphp/detail.php?id='${widget.id}'"));
  ...
  Future _onUpdate(context) async {
    try {
      return await http.post(
        Uri.parse("http://192.168.1.14/sourcebackendphp/edit.php"),
        body: {
          "id": widget.id,
          "nama": nama.text,
          "nim": nim.text,
  ...
  Future _onDelete(context) async {
    try {
      return await http.post(
        Uri.parse("http://192.168.1.14/sourcebackendphp/delete.php"),
        body: {
          "id": widget.id,
        },
      ).then((value) {
